        ...
        <div class="form">
            ...
            <form action="../Connections/display.php" id="test" method="POST">
                        ...
                        <div style="float: left; width: 100%;" class="disappear">
                            ...
                            <input type="radio" value="yes" id="yes" name="rad" onchange="change('yes')">Yes 
                            <input type="radio" value="no" id="no" name="rad" onchange="change('no')">No
                        </div>
                        ...
                        <div style="float: left; width: 50%;">
                            ...
                            <select name="reg_ofs" id="reg_ofs">
                                <option disabled value="none" selected>- None -</option>
